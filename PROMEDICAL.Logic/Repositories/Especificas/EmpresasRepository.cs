...
namespace PROMEDICAL.Logic.Repositories
{
    ...
    {
        public async Task<IEnumerable<UDP_Empresas_FindResult>> ListAsync()
        {
            const string sqlQuery = "UDP_Empresas_Select";
            return await Transaction.SelectAsync<UDP_Empresas_FindResult>(sqlQuery);
        }
        public async Task<UDP_Empresas_FindResult> FindAsync(int id)
        {
            const string sqlQuery = "UDP_Empresas_Find";
            var parameter = new DynamicParameters();
            parameter.Add("@emps_Id", id, DbType.Int32, ParameterDirection.Input);
            return await Transaction.FindAsync<UDP_Empresas_FindResult>(sqlQuery, parameter);
        }
        public async Task<Boolean> AddAsync(tbEmpresas entity)
        {
            ...
            parameter.Add("@emps_Direccion", entity.emps_Direccion, DbType.String, ParameterDirection.Input);
            parameter.Add("@emps_UsuarioRegistra", entity.emps_UsuarioRegistra, DbType.Int32, ParameterDirection.Input);
