    ...
    public class TipoCitasService
    {
        ...
        public async Task<ServiceResult> ListAsync()
        {
            ...
            try
            {
                ...
                apiServiceResult.Data = _mapper.Map<List<TipoCitasSelectDto>>(repositoryResult.ToList());
        ...
        public async Task<ServiceResult> FindAsync(int id)
        {
            ...
            try
            {
                ...
                apiServiceResult.Data = _mapper.Map<TipoCitasFindDto>(repositoryResult);
                if (apiServiceResult.Data == null)
                    return apiServiceResult.Error();
        ...
        public async Task<ServiceResult> DetailAsync(int id)
        {
            ...
            try
            {
                ...
                apiServiceResult.Data = _mapper.Map<TipoCitasDetailDto>(repositoryResult);
                if (apiServiceResult.Data == null)
                    return apiServiceResult.Error();
        ...
        public async Task<ServiceResult> AddAsync(TipoCitasCreateDto dto)
        {
            ServiceResult apiServiceResult = new ServiceResult();
        ...
        public async Task<ServiceResult> EditAsync(TipoCitasUpdateDto dto)
        {
            ServiceResult apiServiceResult = new ServiceResult();
