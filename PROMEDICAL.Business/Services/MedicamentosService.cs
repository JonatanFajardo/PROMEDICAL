    ...
    public class MedicamentosService
    {
        ...
        public async Task<ServiceResult> ListAsync()
        {
            ...
            try
            {
                ...
                apiServiceResult.Data = _mapper.Map<List<MedicamentosSelectDto>>(repositoryResult.ToList());
        ...
        public async Task<ServiceResult> FindAsync(int id)
        {
            ...
            try
            {
                ...
                apiServiceResult.Data = _mapper.Map<MedicamentosFindDto>(repositoryResult);
                if (apiServiceResult.Data == null)
                    return apiServiceResult.Error();
        ...
        public async Task<ServiceResult> DetailAsync(int id)
        {
            ...
            try
            {
                ...
                apiServiceResult.Data = _mapper.Map<MedicamentosDetailDto>(repositoryResult);
                if (apiServiceResult.Data == null)
                    return apiServiceResult.Error();
        ...
        public async Task<ServiceResult> AddAsync(MedicamentosCreateDto dto)
        {
            ServiceResult apiServiceResult = new ServiceResult();
        ...
        public async Task<ServiceResult> EditAsync(MedicamentosUpdateDto dto)
        {
            ServiceResult apiServiceResult = new ServiceResult();
