...
{
    public class EmpleadosCreateValidator : AbstractValidator<Empleados_CreateDto>
    {
    ...
    public class EmpleadosUpdateValidator : AbstractValidator<Empleados_UpdateDto>
    {
