			...
			return new ServiceResult()
			{
				...
				Data = new List<FrecuenciasCardiacasSelectDto>()
				{
					new FrecuenciasCardiacasSelectDto()
					{
                        ...
                        rica_FechaRegistra = Convert.ToDateTime("10/22/2015 12:10:15 PM"), //DateTime.Parse("16-03-2022", System.Globalization.CultureInfo.InvariantCulture),
						rica_UsuarioModifica = 1,
                        //rica_FechaModifica = Convert.ToDateTime("16-03-2022")
						rica_FechaModifica = Convert.ToDateTime("10/22/2015 12:10:15 PM"),//DateTime.Parse("16-03-2022", System.Globalization.CultureInfo.InvariantCulture)
					},
					new FrecuenciasCardiacasSelectDto()
					{
						rica_Id = 15,
